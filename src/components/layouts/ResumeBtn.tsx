...
export default function ResumeBtn() {
  ...
  return (
    <a
      ...
      aria-label="Resume"
      className="group  duration-150 flex justify-center items-center relative h-[34px] w-[100px] overflow-hidden border-[.01px] border-gray-800 hover:border-none hover:bg-accentColor hover:shadow-resume_btn_shadow hover:webkit-reflect"
    >
