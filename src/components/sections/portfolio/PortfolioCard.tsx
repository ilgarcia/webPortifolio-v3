...
function PortfolioCard({ item }: Props) {
  ...
  return (
    <div className="group relative overflow-hidden w-full h-[400px] flex flex-col shadow shadow-border border border-border rounded-lg bg-card">
      ...
      <div className=" relative flex-1 after:absolute after:content-[''] after:rounded-full after:w-8 after:h-8 after:bg-primary after:-bottom-7 after:-right-7 after:origin-center after:transition-transform after:duration-500 after:ease-out group-hover:after:scale-[30] after:opacity-30">
    ...
    //1     <div className="w-full px-4 absolute left-[50%] -translate-x-1/2 z-20 flex flex-col gap-2 items-start ">
    //2       <div className="w-full flex justify-between items-center">
    //3         <div className="text-accentColor group-hover:text-white font-medium">
    //           {item.title}
    //2         </div>
    //3         <div className="flex items-center group">
    //           <svg
    ...
    //           </svg>
    //4           <div className="font-medium text-sm">{starCount}</div>
    //3         </div>
    //2       </div>
    //3       <div className="text-black text-sm group-hover:text-white">
    //         {item.description}
    //2       </div>
    //1     </div>
