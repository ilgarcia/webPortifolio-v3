    ...
    >
      ...
      <div className=" w-full bg-indigo-500/10">
        <div className="relative flex flex-col items-center mx-auto max-w-7xl gap-8">
          <h3 className="contact-line relative top-0 -translate-y-1/2 text-4xl text-orange-400">
            Igor Lima Garcia
          </h3>
          <div className=" flex-col items-center text-center max-w-xl">
            <h4 className="font-semibold">Text title text</h4>
            <p>
          ...
          <div className="contact-line relative bottom-0 translate-y-1/2">
            <div className="flex items-center gap-4">
              <Link
                ...
                className="rounded-full flex items-center gap-2 border py-[1px] px-4 bg-background"
              >
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-full flex items-center gap-2 border py-[5px] px-4 bg-background"
              >
                <svg
