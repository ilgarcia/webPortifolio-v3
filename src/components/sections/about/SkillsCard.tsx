...
function SkillsCard() {
  return (
    ...
    >
      <div className="tag-animation p-8 max-w-xs relative shadow-xl bg-background-secondary border border-gray-800 rounded-md">
      ...
      <div className="tag-animation relative p-8 max-w-xs left-24 shadow-xl bg-background-secondary border border-gray-800 rounded-md">
